    ...
    with _lock:
        ...
        try:
            ...
            if "news_deframe_sentencizer" not in loaded.pipe_names:
                ...
                if "parser" in loaded.pipe_names:
                    loaded.add_pipe("news_deframe_sentencizer", before="parser")
                elif "senter" in loaded.pipe_names:
                    loaded.add_pipe("news_deframe_sentencizer", before="senter")
                else:
                    loaded.add_pipe("news_deframe_sentencizer", last=True)
            _cache[lang] = loaded
